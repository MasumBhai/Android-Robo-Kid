...
public class SendOTP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editablePhone = findViewById(R.id.inputMobile);
        ...
        generateOTPBtn.setOnClickListener(view -> {
            if (editablePhone.getText().toString().trim().isEmpty()) {
                Toast.makeText(SendOTP.this, "Enter your mobile number", Toast.LENGTH_LONG).show();
            } else if (editablePhone.getText().toString().length() == 11) {
                String phone = "+88" + editablePhone.getText().toString();
                sendVerificationCode(phone);
            } else {
                Toast.makeText(SendOTP.this, "Enter a valid mobile number", Toast.LENGTH_LONG).show();
            }
        });
